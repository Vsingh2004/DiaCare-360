...
const ExpertRecommend = ({ setCategory, selectedCategory }) => {
  return (
    <div className="py-12">
      <div className=" px-5">
            ...
            return (
              ...
              >
                <img
                  ...
                  alt={menu_name}
                  className={`w-30 h-30 rounded-full object-cover shadow-lg transition duration-300 ${selectedCategory === menu_name ? "border-4 border-green-600" : ""}`}
                />
